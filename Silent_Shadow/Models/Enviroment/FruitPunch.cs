...
namespace Silent_Shadow.Models.Enviroment
{
	...
	/// </remarks>
	public class FruitPunch : LightSource
	{
		private readonly Animation _spriteAnimation;

		public FruitPunch(Vector2 position, float radius) : base(position, radius, Color.GreenYellow)
		{
			Sprite = Globals.Content.Load<Texture2D>("Sprites/FruitPunch");
