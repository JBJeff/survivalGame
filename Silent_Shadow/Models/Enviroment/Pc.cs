...
{
	public class Pc: LightSource
	{
		private readonly Texture2D _textureDeactivated;
		private readonly Animation _spriteAnimation;

		public Pc(Vector2 position, float radius) : base(position, radius, Color.LimeGreen)
		{
			Sprite = Globals.Content.Load<Texture2D>("Sprites/pc");
